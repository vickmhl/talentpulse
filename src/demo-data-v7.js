window.TALENTPULSE_DEMO_V7 = (function () {
  ...
  const headcountAnchors = {
    "2022-12": {
      "战略办公室": 6, "产品与设计": 22, "研发中心": 60, "销售增长": 28, "客户成功": 18, "交付运营": 18, "市场品牌": 8, "人力资源": 7, "财务法务": 6, "IT与数据平台": 10
    },
    "2023-12": {
      "战略办公室": 7, "产品与设计": 28, "研发中心": 80, "销售增长": 38, "客户成功": 24, "交付运营": 22, "市场品牌": 10, "人力资源": 8, "财务法务": 7, "IT与数据平台": 12
    },
    "2024-12": {
      "战略办公室": 8, "产品与设计": 32, "研发中心": 92, "销售增长": 50, "客户成功": 34, "交付运营": 28, "市场品牌": 12, "人力资源": 10, "财务法务": 8, "IT与数据平台": 14
    },
    "2025-12": {
      "战略办公室": 8, "产品与设计": 34, "研发中心": 96, "销售增长": 52, "客户成功": 36, "交付运营": 30, "市场品牌": 12, "人力资源": 10, "财务法务": 9, "IT与数据平台": 13
    }
  };
  ...
  function recruitingReqs(workforceRows) {
    const reqs = [];
    let reqIndex = 1;
    workforceRows.filter((row) => row.department !== "战略办公室").forEach((row, index) => {
      ...
      for (let i = 0; i < demand; i += 1) {
        ...
        const baseTtf = year === 2023 ? 52 : year === 2024 ? 58 : 44;
        const storyLift = config.story === "engineering" ? 12 : config.story === "sales" && year === 2024 ? 14 : config.story === "product" ? 10 : config.story === "support" ? 8 : 4;
        const timeToFill = baseTtf + storyLift + ((index + i) % 11);
        ...
        const totalCost = agencyCost + 12000 + ((index + i) % 9) * 1600 + (criticalRole ? 8000 : 0);
        reqs.push({
  ...
  const metadata = {
    ...
    industry: "面向中大型企业的 B2B SaaS + 交付服务公司",
