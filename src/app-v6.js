(function () {
  ...
  function renderShell() {
    const content = state.route === "home" ? renderHomeV6() : state.route === "overview" ? renderOverviewV6() : state.route === "review" ? renderTalentReviewV6() : state.route === "succession" ? renderSuccessionV6() : state.route === "health" ? renderHealthV6() : state.route === "profile" ? renderProfile() : renderReportV6();
