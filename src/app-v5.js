(function () {
  ...
  function renderShell() {
    const content = state.route === "home" ? renderHomeV5() : state.route === "overview" ? renderOverviewV5() : state.route === "review" ? renderTalentReviewV5() : state.route === "succession" ? renderSuccessionV5() : state.route === "health" ? renderHealthV5() : state.route === "profile" ? renderProfile() : renderReportV5();
  ...
  function downloadReport() {
    ...
    link.href = url;
    link.download = "澄曜科技-组织诊断汇报摘要.txt";
    link.click();
